...
# Unit tests for Harbor2Client::WebhookjobApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookjobApi' do
  before do
    # run before each test
    @instance = Harbor2Client::WebhookjobApi.new
  end
  ...
  describe 'test an instance of WebhookjobApi' do
    it 'should create an instance of WebhookjobApi' do
      expect(@instance).to be_instance_of(Harbor2Client::WebhookjobApi)
    end
  end

  # unit tests for list_webhook_jobs
  ...
  describe 'list_webhook_jobs test' do
    it 'should work' do
