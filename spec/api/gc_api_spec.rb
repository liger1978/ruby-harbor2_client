...
# Unit tests for Harbor2Client::GcApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GcApi' do
  before do
    # run before each test
    @instance = Harbor2Client::GcApi.new
  end
  ...
  describe 'test an instance of GcApi' do
    it 'should create an instance of GcApi' do
      expect(@instance).to be_instance_of(Harbor2Client::GcApi)
    end
  end

  # unit tests for create_gc_schedule
  ...
  # @return [nil]
  describe 'create_gc_schedule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_gc
  # Get gc status.
  ...
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [GCHistory]
  describe 'get_gc test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_gc_history
  # Get gc results.
  ...
  describe 'get_gc_history test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_gc_log
  # Get gc job log.
  ...
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [String]
  describe 'get_gc_log test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_gc_schedule
  # Get gc&#39;s schedule.
  # This endpoint is for get schedule of gc job.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [GCHistory]
  describe 'get_gc_schedule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_gc_schedule
  ...
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [nil]
  describe 'update_gc_schedule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
