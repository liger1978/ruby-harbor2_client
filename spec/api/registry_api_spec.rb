...
# Unit tests for Harbor2Client::RegistryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegistryApi' do
  before do
    # run before each test
    @instance = Harbor2Client::RegistryApi.new
  end
  ...
  describe 'test an instance of RegistryApi' do
    it 'should create an instance of RegistryApi' do
      expect(@instance).to be_instance_of(Harbor2Client::RegistryApi)
    end
  end
  ...
  # unit tests for get_registry_info
  ...
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [RegistryInfo]
  describe 'get_registry_info test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_registry_provider_infos
  # List all registered registry provider information
  # List all registered registry provider information
  # @param [Hash] opts the optional parameters
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [Hash<String, RegistryProviderInfo>]
  describe 'list_registry_provider_infos test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_registry_provider_types
  # List registry adapters
  # List registry adapters
  # @param [Hash] opts the optional parameters
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [Array<String>]
  describe 'list_registry_provider_types test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ping_registry
  ...
  # @option opts [String] :x_request_id An unique ID for the request
  # @return [nil]
  describe 'ping_registry test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
