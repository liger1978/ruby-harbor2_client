...
# Unit tests for Harbor2Client::ImmutableApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImmutableApi' do
  before do
    # run before each test
    @instance = Harbor2Client::ImmutableApi.new
  end
  ...
  describe 'test an instance of ImmutableApi' do
    it 'should create an instance of ImmutableApi' do
      expect(@instance).to be_instance_of(Harbor2Client::ImmutableApi)
    end
  end

  # unit tests for create_immu_rule
  # Add an immutable tag rule to current project
  # This endpoint add an immutable tag rule to the project 
  # @param project_name_or_id The name or id of the project
  # @param immutable_rule 
  ...
  # @return [nil]
  describe 'create_immu_rule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_immu_rule
  # Delete the immutable tag rule.
  # @param project_name_or_id The name or id of the project
  # @param immutable_rule_id The ID of the immutable rule
  # @param [Hash] opts the optional parameters
  # @option opts [String] :x_request_id An unique ID for the request
  # @option opts [BOOLEAN] :x_is_resource_name The flag to indicate whether the parameter which supports both name and id in the path is the name of the resource. When the X-Is-Resource-Name is false and the parameter can be converted to an integer, the parameter will be as an id, otherwise, it will be as a name.
  # @return [nil]
  describe 'delete_immu_rule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_immu_rules
  ...
  # @return [Array<ImmutableRule>]
  describe 'list_immu_rules test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_immu_rule
  ...
  # @option opts [BOOLEAN] :x_is_resource_name The flag to indicate whether the parameter which supports both name and id in the path is the name of the resource. When the X-Is-Resource-Name is false and the parameter can be converted to an integer, the parameter will be as an id, otherwise, it will be as a name.
  # @return [nil]
  describe 'update_immu_rule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
