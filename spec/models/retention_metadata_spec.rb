...
# Unit tests for Harbor2Client::RetentionMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RetentionMetadata' do
  before do
    # run before each test
    @instance = Harbor2Client::RetentionMetadata.new
  end
  ...
  describe 'test an instance of RetentionMetadata' do
    it 'should create an instance of RetentionMetadata' do
      expect(@instance).to be_instance_of(Harbor2Client::RetentionMetadata)
    end
  end
