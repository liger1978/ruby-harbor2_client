...
# Unit tests for Harbor2Client::RegistryCredential
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegistryCredential' do
  before do
    # run before each test
    @instance = Harbor2Client::RegistryCredential.new
  end
  ...
  describe 'test an instance of RegistryCredential' do
    it 'should create an instance of RegistryCredential' do
      expect(@instance).to be_instance_of(Harbor2Client::RegistryCredential)
    end
  end
