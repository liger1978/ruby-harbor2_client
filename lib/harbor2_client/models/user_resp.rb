...
module Harbor2Client
  class UserResp
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'oidc_user_meta')
        self.oidc_user_meta = attributes[:'oidc_user_meta']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          oidc_user_meta == o.oidc_user_meta &&
    ...
    def hash
      [email, realname, comment, user_id, username, sysadmin_flag, admin_role_in_auth, oidc_user_meta, creation_time, update_time].hash
    end
