...
module Harbor2Client
  ...
  class ScannerRegistration
    ...
    def hash
      [uuid, name, description, url, disabled, is_default, auth, access_credential, skip_cert_verify, use_internal_addr, create_time, update_time, adapter, vendor, version, health].hash
    end
