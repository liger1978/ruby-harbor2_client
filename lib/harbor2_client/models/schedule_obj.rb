...
module Harbor2Client
  class ScheduleObj
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['Hourly', 'Daily', 'Weekly', 'Custom', 'Manual', 'None'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['Hourly', 'Daily', 'Weekly', 'Custom', 'Manual', 'None'])
