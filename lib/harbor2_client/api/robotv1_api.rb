...
module Harbor2Client
  class Robotv1Api
    ...
    # @return [RobotCreated]
    def create_robot_v1(project_name_or_id, robot, opts = {})
      data, _status_code, _headers = create_robot_v1_with_http_info(project_name_or_id, robot, opts)
      data
    end
    ...
    def create_robot_v1_with_http_info(project_name_or_id, robot, opts = {})
      ...
      if @api_client.config.client_side_validation && project_name_or_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_name_or_id' when calling Robotv1Api.create_robot_v1"
      end
      ...
      # resource path
      local_var_path = '/projects/{project_name_or_id}/robots'.sub('{' + 'project_name_or_id' + '}', project_name_or_id.to_s)
    ...
    # @option opts [BOOLEAN] :x_is_resource_name The flag to indicate whether the parameter which supports both name and id in the path is the name of the resource. When the X-Is-Resource-Name is false and the parameter can be converted to an integer, the parameter will be as an id, otherwise, it will be as a name. (default to false)
    # @return [nil]
    def delete_robot_v1(project_name_or_id, robot_id, opts = {})
      delete_robot_v1_with_http_info(project_name_or_id, robot_id, opts)
      nil
    end
    ...
    def delete_robot_v1_with_http_info(project_name_or_id, robot_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Robotv1Api.delete_robot_v1 ...'
      end
      # verify the required parameter 'project_name_or_id' is set
      if @api_client.config.client_side_validation && project_name_or_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_name_or_id' when calling Robotv1Api.delete_robot_v1"
      end
      ...
      # resource path
      local_var_path = '/projects/{project_name_or_id}/robots/{robot_id}'.sub('{' + 'project_name_or_id' + '}', project_name_or_id.to_s).sub('{' + 'robot_id' + '}', robot_id.to_s)
    ...
    # @option opts [BOOLEAN] :x_is_resource_name The flag to indicate whether the parameter which supports both name and id in the path is the name of the resource. When the X-Is-Resource-Name is false and the parameter can be converted to an integer, the parameter will be as an id, otherwise, it will be as a name. (default to false)
    # @return [Robot]
    def get_robot_by_idv1(project_name_or_id, robot_id, opts = {})
      data, _status_code, _headers = get_robot_by_idv1_with_http_info(project_name_or_id, robot_id, opts)
      data
    end
    ...
    def get_robot_by_idv1_with_http_info(project_name_or_id, robot_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Robotv1Api.get_robot_by_idv1 ...'
      end
      # verify the required parameter 'project_name_or_id' is set
      if @api_client.config.client_side_validation && project_name_or_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_name_or_id' when calling Robotv1Api.get_robot_by_idv1"
      end
      # verify the required parameter 'robot_id' is set
      if @api_client.config.client_side_validation && robot_id.nil?
    ...
    # @return [Array<Robot>]
    def list_robot_v1(project_name_or_id, opts = {})
      data, _status_code, _headers = list_robot_v1_with_http_info(project_name_or_id, opts)
      data
    end
    ...
    def list_robot_v1_with_http_info(project_name_or_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Robotv1Api.list_robot_v1 ...'
      end
      # verify the required parameter 'project_name_or_id' is set
      if @api_client.config.client_side_validation && project_name_or_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_name_or_id' when calling Robotv1Api.list_robot_v1"
      end
      if @api_client.config.client_side_validation && !opts[:'x_request_id'].nil? && opts[:'x_request_id'].to_s.length < 1
    ...
    # @option opts [BOOLEAN] :x_is_resource_name The flag to indicate whether the parameter which supports both name and id in the path is the name of the resource. When the X-Is-Resource-Name is false and the parameter can be converted to an integer, the parameter will be as an id, otherwise, it will be as a name. (default to false)
    # @return [nil]
    def update_robot_v1(project_name_or_id, robot_id, robot, opts = {})
      update_robot_v1_with_http_info(project_name_or_id, robot_id, robot, opts)
      nil
    end
    ...
    # @option opts [BOOLEAN] :x_is_resource_name The flag to indicate whether the parameter which supports both name and id in the path is the name of the resource. When the X-Is-Resource-Name is false and the parameter can be converted to an integer, the parameter will be as an id, otherwise, it will be as a name.
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_robot_v1_with_http_info(project_name_or_id, robot_id, robot, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Robotv1Api.update_robot_v1 ...'
      end
      # verify the required parameter 'project_name_or_id' is set
      if @api_client.config.client_side_validation && project_name_or_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_name_or_id' when calling Robotv1Api.update_robot_v1"
      end
      # verify the required parameter 'robot_id' is set
      if @api_client.config.client_side_validation && robot_id.nil?
